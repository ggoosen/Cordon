...
check "installer: all four skills placed" "[ -f '$TGT/.claude/skills/cordon-review/SKILL.md' ] && [ -f '$TGT/.claude/skills/cordon-accept/SKILL.md' ] && [ -f '$TGT/.claude/skills/cordon-discard/SKILL.md' ] && [ -f '$TGT/.claude/skills/cordon-status/SKILL.md' ]"
